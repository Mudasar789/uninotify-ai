        ...
        <Card className="bg-black/40 border-purple-500/30 backdrop-blur-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-gray-400">
              Join thousands of students discovering their perfect university with AI
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start">
                <input
                  ...
                  className="rounded border-purple-500/30 bg-black/20 text-purple-500 focus:ring-purple-500 mt-1"
                />
